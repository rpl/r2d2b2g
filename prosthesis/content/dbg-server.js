...
let wantLogging = true; //Services.prefs.getBoolPref("devtools.debugger.log");
...
//@line 189 "/home/myk/Mozilla/central/toolkit/devtools/debugger/server/dbg-server.js"
...
//@line 193 "/home/myk/Mozilla/central/toolkit/devtools/debugger/server/dbg-server.js"
  ...
  connectToTCPServer: function DH_connectToTCPServer(aHost, aPort) {
    dumpn("New ACTIVE CONNECTION TO: "+aHost+":"+aPort);
    try {
      this._checkInit();
      ...
      dumpn("Couldn't initialize ACTIVE connection: " + e + " - " + e.stack);
    }
  },
